...
//    int blocksize;
    ...
    cudaMalloc((void **)&d_img, sizeof(char)*HEIGHT*WIDTH*3);

    dim3 dimBlock(16, 16);
    dim3 dimGrid(HEIGHT/16, WIDTH/16);
    ...
    struct timeval start_ete, end_ete;
    ...
    process<<<dimGrid, dimBlock>>>(d_img);
    cudaDeviceSynchronize();
    cudaMemcpy(img, d_img, sizeof(char)*HEIGHT*WIDTH, cudaMemcpyDeviceToHost);
