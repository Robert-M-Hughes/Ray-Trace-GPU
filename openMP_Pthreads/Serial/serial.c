...
int main(int argc, char *argv[]){
  ...
  double elapsed_time;
	...
	materials[3].diffuse.red = .5;
	materials[3].diffuse.green = 0;
	materials[3].diffuse.blue = 1;
	materials[3].reflection = 0.75;

	materials[4].diffuse.red = 0;
	materials[4].diffuse.green = .5;
	materials[4].diffuse.blue = 1;
	materials[4].reflection = 0.6;

	materials[5].diffuse.red = 1;
	materials[5].diffuse.green = 0;
	materials[5].diffuse.blue = 1;
	materials[5].reflection = 0.3;
